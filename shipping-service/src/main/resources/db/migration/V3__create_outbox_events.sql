...
-- Rows are inserted within the same DB transaction as
-- createShipment() or confirmDelivery().
-- A @TransactionalEventListener(AFTER_COMMIT) publishes to shipping.events.
-- ============================================================
...
CREATE TABLE outbox_events (
    ...
    event_type    VARCHAR(200) NOT NULL,   -- "ShipmentCreated" | "ShipmentDelivered"
